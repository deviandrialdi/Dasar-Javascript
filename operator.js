...
// add = a + b;
// console.log("hasil penjumlahan a + b", add);
// sub = a - b;
// console.log("hasil pengurangan a - b", sub);
// mul = a * b;
// console.log("hasil perkalian a * b", mul);
// div = a / b;
// console.log("hasil perkalian a / b", div);
// mod = a % b;
// console.log("hasil modulus a / b", mod);
