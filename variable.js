...
// REDECLARE => adalah dia bisa diinisialisasi ulang
/*
var foo = "foo";
var foov = "bar";
Output => bar
...
synatxError : Identifier 'baz' has already been declared
*/
...
// HOISTING => kita pake dulu datanya baru diinialisasi. kasarnya kita sudah didunia tapi orangtua belum ada (Paradox).
/*
foo = "foo";
var foo;
console.log(foo);
